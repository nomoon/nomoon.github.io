...
config[:casper] = {
  blog: {
    url: "https://nomoon.github.io",
    name: "There's No Moon Over the Web",
    description: "Software Development & Sanskrit Digital Humanities",
    date_format: "%d %B %Y",
    navigation: true,
    logo: nil # Optional
  },
  author: {
    ...
    gravatar_email: "nomoon@phoebus.ca", # Optional
    twitter: "@nomoon" # Optional
  },
  navigation: {
    "Home" => "/",
  },
